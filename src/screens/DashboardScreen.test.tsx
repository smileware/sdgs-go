...
describe('DashboardScreen kiosk layout', () => {
  it('shows a looping video, total participants, and every result category', async () => {
    ...
    expect(video).toHaveAttribute(
      'src',
      'https://www.youtube-nocookie.com/embed/uD20QdgEPJk?autoplay=1&mute=0&controls=1&loop=1&playlist=uD20QdgEPJk&playsinline=1&disablekb=1&fs=0&iv_load_policy=3&rel=0',
    )
